...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="<?php echo base_url('travel'); ?>" style="color: whitesmoke">Add</a></button></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="myForm" action="" method="post" class="form-horizontal">
            ...
            <div class="form-group">
              <label for="name" class="label-control col-md-4">Travel Type</label>
              <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="text" name="travel_type_sht_desc" class="form-control">
              </div>
            </div>
             <div class="form-group">
                  <div class="col-md-8">
...
<script>
  $(function(){
    ...
    $('#btnAdd').click(function(){
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Add New Travel Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>travel/addtravel');
    });
    ...
    $('#btnSave').click(function(){
      ...
      if(travel_type_desc.val()==''){
        ...
        travel_type_desc.parent().parent().removeClass('has-error');
        result +='1';
      }
      if(address.val()==''){
    ...
    $('#showdata').on('click', '.item-edit', function(){
      var travel_type_id = $(this).attr('data');
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Edit Travel Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>travel/updatetravel');
      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url() ?>travel/edittravel',
        data: {travel_type_id: travel_type_id},
        async: false,
        dataType: 'json',
    ...
    $('#showdata').on('click', '.item-delete', function(){
      ...
      $('#btnDelete').unbind().click(function(){
        $.ajax({
          ...
          method: 'get',
          async: false,
          url: '<?php echo base_url() ?>travel/deletetravel',
          data:{travel_type_id:travel_type_id},
          dataType: 'json',
          success: function(response){
            if(response.success){
              $('#deleteModal').modal('hide');
              $('.alert-success').html('Travel Type Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
              showAlltravel();
            }else{
              alert('Error');
            }
    ...
    //function
    function showAlltravel(){
    var tableSrc = '<?php echo base_url() ?>travel/showAlltravel';
      ...
      $('#example1').dataTable({
          ...
          "aoColumns": [
              ...
              { "sTitle": "Travel Type", "sType": "string" },
