...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="<?php echo base_url('branch'); ?>" style="color: whitesmoke">Add</a></button></li>
...
<script>
  $(function(){
    ...
    $('#btnAdd').click(function(){
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Add New branch Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>branch/addbranch');
    });
    ...
    $('#btnSave').click(function(){
      ...
      var result = '';
      if(branch_name.val()==''){
        branch_name.parent().parent().addClass('has-error');
      }else{
        branch_name.parent().parent().removeClass('has-error');
        result +='1';
      }
    ...
    $('#showdata').on('click', '.item-edit', function(){
      ...
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Edit branch Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>branch/updatebranch');
      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url() ?>branch/editbranch',
    ...
    $('#showdata').on('click', '.item-delete', function(){
      ...
      $('#btnDelete').unbind().click(function(){
        $.ajax({
          ...
          method: 'get',
          async: false,
          url: '<?php echo base_url() ?>branch/deletebranch',
          data:{branch_id:branch_id},
          dataType: 'json',
          success: function(response){
            if(response.success){
              $('#deleteModal').modal('hide');
              $('.alert-success').html('branch Type Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
              showAllbranch();
            }else{
              alert('Error');
            }
    ...
    var tableSrc = '<?php echo base_url() ?>branch/showAllbranch';
      ...
      $('#example1').dataTable({
          ...
          "aoColumns": [
              ...
              { "sTitle": "Branch Name", "sType": "string" },
