  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="../../pages/forms/general.html" style="color: whitesmoke">Add</a></button></li>
            ...
            <div class="box-body"  style="overflow-x: auto">
              <table id="example1" class="table table-bordered table-striped"  style="width:auto">
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-primary btn-xs" ng-click="r.changeView('requests/edit/' + request.id)" data-toggle="modal" data-target="#myModal">
         Edit
        </button>
    ...
    border-radius: 2px;">
      ...
      <section class="content">
        <div class="row">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <table>
                    <tr>
                      <td>
                        <input type="number" class="form-control" placeholder="Number" id="exampleInputEmail1" style="width: 100%">
                      </td>
                      <td>
                        <button class="btn btn-primary btn-sm" style="margin-left: 240%;">Add</button>
                      </td>
                    </tr>
                  </table>
          ...
          <div class="col-md-4">
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <input type="email" class="form-control" placeholder="Dedicated Hotels" id="exampleInputEmail1">
                </div>
                <div class="form-group">
                  <table>
                    <tr>
                      <td>
                        <input type="text" class="form-control" placeholder="Fax" id="exampleInputPassword1" style="width: 100%">
                      </td>
                      <td>
                        <button class="btn btn-primary btn-sm" style="margin-left: 240%;">Add</button>
                      </td>
        ...
        <div class="row" style="margin-bottom: 3%">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <select class="form-control" style="    width: 95%;margin-left: 3%;">
        ...
        <div class="row" style="margin-bottom: 3%">
          ...
          <form action="post">
            <div class="col-md-2">
              <div class="form-group">
                <input type="number" class="form-control" placeholder="S.No" style="    width: 95%;margin-left: 2%;" required>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Name" style="width: 95%;margin-left: 2%;" required>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Title" style="    width: 95%;margin-left: 2%;" required>
              </div>
            </div>

            <div class="col-md-2">
              <div class="form-group">
                <input type="number" class="form-control" placeholder="Phone" style="    width: 95%;margin-left: 2%;" required>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <input type="number" class="form-control" placeholder="Mobile" style="    width: 95%;margin-left: 2%;" required>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
                <input type="email" class="form-control" placeholder="Email" style="    width: 95%;margin-left: 2%;">
              </div>
            </div>
