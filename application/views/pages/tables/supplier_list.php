 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="<?php echo base_url('index.php/home/add_supplier'); ?>" style="color: whitesmoke">Add</a></button></li>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <table>
                    <tr>
                      <td>
                        <input type="number" class="form-control" placeholder="Phone Number" id="exampleInputEmail1" style="width: 100%">
                      </td>
                      <td>
          ...
          <div class="col-md-4">
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  <select class="form-control">
                    <option>Dedicated Hotels</option>
                    <option>option 2</option>
                    <option>option 3</option>
                    <option>option 4</option>
                    <option>option 5</option>
