<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm" style="width: 100%;border-radius: 30px;"><a href="<?php echo base_url('supplier'); ?>" style="color: whitesmoke">Add</a></button></li>
          ...
          <!-- general form elements -->
            ...
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" class="form-control" placeholder="Name" name="supplier_name" style="width: 100%;padding: 8px;border-radius: 1px;">
            ...
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" placeholder="Short Name" name="supplier_sht_name" id="supplier_sht_name">
                </div>
           ...
           <div>
            <label>Phone</label>
             <input type="text" required="phone" maxlength="11" minlength="10" class="form-control" placeholder="03333906233" style="width: 55%" name="phone[]" data-role="phone" value=""/>
                          <a href="javascript:void(0);" class="add_button " title="Add field" style="position: relative;bottom: 31px;left: 163px;"><img src="<?php echo base_url('assets/images/add-icon.png'); ?>"/></a>/></a>
           </div>
         </div>
       </tr>
    </table>
  ...
  <div class="col-md-4">
      ...
      <div class="panel">
        <br>
                      ...
                      <div class="form-group">
                        <label>Name</label>
                        <input type="name" class="form-control" placeholder="Name" name="contact_person_name[]" id="contact_person_name">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" placeholder="Email" name="contact_person_email[]" id="contact_person_email">
                      </div>
        <div class="form-group">
...
<script>
  ...
  $(function(){
    ...
    $('#btnAdd').click(function(){
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Add New supplier Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>supplier/addsupplier');
    });
    ...
    $('#showdata').on('click', '.item-edit', function(){
      ...
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Edit supplier Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>supplier/updatesupplier');
      $.ajax({
        type: 'ajax',
        method: 'get',
        ...
        success: function(data){
          ...
          $('input[name=supplier_sht_name]').val(data.supplier_sht_name);
          ...
          if (attachement_detail.length > 0) {
            for(let i=0; i < attachement_detail.length; i++){
              $('#myTableFiles tbody').append('<tr><td><input type="text" class="form-control" placeholder="File Description" value="'+attachement_detail[i].file_description+'" name="file_description['+i+'][]" id="file_description[]"></td><td><a href="<?= base_url('assets/supplier_file') ?>/'+attachement_detail[i].file_upload+'" target="_blank">'+attachement_detail[i].file_upload+'<a/><input type="file" class="form-control hidden" placeholder="Upload File" name="file_name['+i+'][]" id="file_name"><input type="hidden" name="file_name_hidden['+i+'][]" id="file_name_hidden" value="'+attachement_detail[i].file_upload+'"></td><td><img src="<?= base_url('assets/supplier_file') ?>/'+attachement_detail[i].file_upload+'" width="50" height="50" /></td><td><input type="button" class="ibtnDel btn btn-md btn-danger " value="Delete"></td></tr>');
            }
          }
        ...
        $.ajax({
          ...
          success: function(response){
            if(response.success){
              ...
              $('.alert-success').html('supplier Type Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
              showAllsupplier();
            }else{
              alert('Error');
            }
          ...
          error: function(){
            alert('supplier has not been deleted. This Term id is using in another table.');
          }
        });
      });
    });
    ...
    function showAllsupplier(){
       var tableSrc = '<?php echo base_url() ?>supplier/showAllsupplier';
 ...
 <script type="text/javascript">
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="text" class="form-control" name="file_description['+window.attachement_detail_global_count+'][]" placeholder="File Description"  /></td>';
        cols += '<td><input type="file" class="form-control" placeholder="Upload File" name="file_name['+window.attachement_detail_global_count+'][]"/></td>';
