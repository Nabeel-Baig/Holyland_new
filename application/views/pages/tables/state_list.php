<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="<?php echo base_url('state'); ?>" style="color: whitesmoke">Add</a></button></li>
    ...
    <section class="content">
     ...
     <!--            <tr>
                  ...
                  <td><?php //echo $country->state_id; ?></td>
                  <td><?php //echo $country->country_name;?></td>
                  <td><?php //echo $country->state_name; ?></td>
                  <td><?php //echo $country->state_sht_name; ?></td>
 ...
 <a href="<?php //echo base_url() . "state/delete_state_id/" . $country->state_id; ?>" onclick="myFunction()" class="fa fa-times fa-lg" style="color: red;position: relative;left: 15px;">
 ...
 <section class="content">
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input type="hidden" name="state_id" class="form-control" value="0" placeholder="ID Auto Generate">
                  </div>
                  <div class="form-group">
                    <label>Country Name</label>
                    <select list="hosting-plan" id="country_id" name="country_id" style="width: 100%;padding: 5px;border: #cecece solid 1px;">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group" style="margin-top: 10%;">
                  ...
                  <input type="text" name="state_sht_name" class="form-control">
                </div>
      ...
      <!-- <div class="modal-body">
          <form id="myForm" action="" method="post" class="form-horizontal">
            ...
            <div class="form-group">
              <label for="address" class="label-control col-md-4">State Short Name</label>
              <div class="col-md-8">
                <input type="text" name="state_sht_name" class="form-control">
              </div>
            </div>
...
<script>
  ...
  $(function(){
    ...
    $('#btnAdd').click(function(){
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Add New State Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>state/addstate');
    });
    ...
    $('#btnSave').click(function(){
      ...
      var address = $('input[name=state_sht_name]');
      var validate = true;
       if(country_id.val()==''){
        ...
        $.ajax({
          ...
          success: function(response){
            if(response.success){
              ...
              $('.alert-success').html('State '+type+' successfully').fadeIn().delay(4000).fadeOut('slow');
              showAllstate();
            }else{
              alert('Error');
            }
    ...
    $('#showdata').on('click', '.item-edit', function(){
      var state_id = $(this).attr('data');
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Edit state Type');
      $('#myForm').attr('action', '<?php echo base_url() ?>state/updatestate');
      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url() ?>state/editstate',
        ...
        success: function(data){
          ...
          $('input[name=state_sht_name]').val(data.state_sht_name);
        ...
        $.ajax({
          ...
          success: function(response){
            if(response.success){
              ...
              $('.alert-success').html('State Type Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
              showAllstate();
            }else{
              alert('Error');
            }
          ...
          error: function(){
            alert('State has not been deleted. This Country ID and State ID is using in another table.');
          }
        });
      });
    });
    ...
    function showAllstate(){
       var tableSrc = '<?php echo base_url() ?>state/showAllstate';
      ...
      $('#example1').dataTable({
          ...
          "aoColumns": [
              ...
              { "sTitle": "State Short Name", "sType": "string" },
