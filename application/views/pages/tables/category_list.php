...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><button class="btn btn-dropbox btn-sm"><a href="<?php echo base_url('category'); ?>" style="color: whitesmoke">Add</a></button></li>
...
<script>
  $(function(){
    ...
    $('#btnAdd').click(function(){
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Add New category Type');
    ...
    $('#btnSave').click(function(){
      ...
      if(category_desc.val()==''){
        category_desc.parent().parent().addClass('has-error');
      }else{
        category_desc.parent().parent().removeClass('has-error');
        result +='1';
      }
    ...
    $('#showdata').on('click', '.item-edit', function(){
      ...
      $('#myModal').modal('show');
      $('#myModal').find('.modal-title').text('Edit category Type');
      ...
      $.ajax({
        ...
        success: function(data){
          $('input[name=category_desc]').val(data.category_desc);
        ...
        $.ajax({
          ...
          success: function(response){
            if(response.success){
              ...
              $('.alert-success').html('category Type Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
              showAllcategory();
            }else{
              alert('Error');
            }
    ...
    function showAllcategory(){
     var tableSrc = '<?php echo base_url() ?>category/showAllcategory';
