      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <!-- general form elements -->
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="myForm" id="myform" action="<?php echo base_url('meal'); ?>" onsubmit="return validateForm()" method="post">
              <?php echo form_open('meal'); ?>
        ...
        <div class="col-md-5">
          ...
          <div class="form-group" style="margin-top: 2%">
            <?php echo form_label('Meal Name'); ?><?php echo form_error('meal_plan_desc'); ?>
            <input type="text" name="meal_plan_desc" id="meal_plan_desc" class="form-control" placeholder="Meal Name">
          </div>
...
function validateForm() {
    var x = document.forms["myForm"]["meal_plan_desc"].value;
    if (x == "") {
