    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <select name="state" id="state" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;">
              ...
              <div class="form-group" style="margin-top: 2%">
                <?php echo form_label('City Short Name'); ?><?php echo form_error('city_sht_name'); ?> <br />
                <input type="text" id="city_sht_name" name="city_sht_name" class="form-control" placeholder="City Short Name">
              </div>
            </div>
        ...
        <div class="col-md-6" style="margin-top: 10px;">
          ...
          <div class="form-group">
            <?php echo form_label('City Name'); ?><?php echo form_error('city_name'); ?> <br />
                <input type="text" id="city_name" name="city_name" class="form-control" placeholder="City">
          </div>

<div class="form-group">

                  <label for="inactive_flag" class="" style="    font-weight: 400; margin-top: 15%">
...
<script src="<?php echo base_url('assets/bower_components/jquery/dist/jquerys.js'); ?>"></script>
<!-- Bootstrap 3.3.7 -->
