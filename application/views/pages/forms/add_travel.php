          ...
          <!-- general form elements -->
            ...
            <form role="form" action="<?php echo base_url('travel'); ?>" method = "post">
              <div class="box-body">
                ...
                <br>
                <div class="form-group">
                  <?php echo form_label('Travel Type'); ?><?php echo form_error('travel_type_desc'); ?> <br />
                  <?php echo form_input(array('id' => 'travel_type_desc', 'name' => 'travel_type_desc', 'class'=>'form-control', 'placeholder'=>'e.g Hajj, Umra')); ?><br />
                </div>
                ...
                <div class="form-group">
                  ...
                  <label for="inactive_flag" style="    font-weight: 400;    margin-left: 10%;">
                    <input type="radio" id="inactive_flag" name="inactive_flag" value="1" class="checkbox1">
                    Inactive
                  </label>
                </div>
        ...
        <div class="col-md-6">
          <!-- general form elements -->
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="6" id="travel_type_sht_desc" name="travel_type_sht_desc" placeholder="Note"></textarea>
            </div>
