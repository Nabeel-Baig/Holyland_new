      ...
      <div class="row">
          ...
          <!-- general form elements -->
            ...
            <form role="form" action="<?php echo base_url('room'); ?>" method = "post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <?php echo form_label('Name'); ?><?php echo form_error('room_type_name'); ?>
                  <input type="text" id="room_type_name" name="room_type_name" class="form-control" placeholder="Name">
                </div>

                <div class="form-group">
                  <?php echo form_label('No Of Person'); ?><?php echo form_error('no_of_persons'); ?>
                  <input type="number" id="no_of_persons" name="no_of_persons" class="form-control" placeholder="Number Of Person">
                </div>
        ...
        <div class="col-md-5">
          <!-- general form elements -->
            ...
            <div class="form-group">
              <label for="comment" style="margin-top: 4%">Note</label>
              <textarea class="form-control" rows="5" id="note" name="note" placeholder="Note"></textarea>
            </div>
            <div class="form-group">

                  <label for="inactive_flag" class="" style="    font-weight: 400; margin-top: 5%">
