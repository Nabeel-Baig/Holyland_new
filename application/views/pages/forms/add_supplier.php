    ...
    <section class="content">
      <div class="row">
        <div class="box" style="width: 80%;margin-left: 10%;background: #c1c1c1;">
          <div class="box-body">
            <form name="myForm" role="form" id="myform" action="<?php echo base_url('supplier'); ?>" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
        <!-- left column -->
        <div class="col-md-4">
          <!-- general form elements -->
            ...
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Name</label>
                  <input type="name" required="supplier_name" class="form-control" placeholder="Name" name="supplier_name" id="supplier_name" tabindex="1">
                </div>
                 <div class="form-group">
                  <table>
                    <tr>
                      <div class="field_wrapper">
                        <div>
                          <label>Fax</label>
                          <input type="text" class="form-control" maxlength="11" minlength="10" minlength="10" placeholder="03333906233" style="width: 55%" name="fax[]" data-role="fax" value="" tabindex="4" />
                 ...
                 <div class="form-group" style="margin-top: -10%;">
                    <label>Country</label>
                    <select name="country" id="country" required="country" style="width: 100%;border: 1px solid #d4d4d4;padding: 6px;" tabindex="7">
                ...
                <div class="form-group">
                  <label>Address</label>
                  <input type="text" required="address" class="form-control" placeholder="Address" name="address" id="address" tabindex="10">
                </div>

                <div class="form-group">
                  <label>Account No</label>
                  <input type="number" class="form-control" placeholder="Account No" name="gl_ac_no" id="gl_ac_no" tabindex="13">
                </div>

                <div class="form-group">
                  <label>GAZT No</label>
                  <input type="number" class="form-control" placeholder="GAZT No" id="exampleInputEmail1" tabindex="16">
                </div>
                ...
                <div class="form-group">
                    <label>Branch</label>
                   <select name="branch" id="branch" required="branch" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="19">
                      <option value=""></option>
            ...
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Instructions" name="note" id="note" tabindex="2">
                </div>

                  <div class="form-group">
              <label>Short Name</label>
                  <input type="text" class="form-control" placeholder="Short Name" name="supplier_sht_name" id="supplier_sht_name" tabindex="5">
                </div>

                <div class="form-group">
                    <label>Payment Method</label>
                   <select name="payment" id="payment" required="payment" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="8">
                      <option value=""></option>
                ...
                <div class="form-group">
                    ...
                    <select name="state" id="state" required="state" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="11">
                ...
                <div class="form-group">
                  <label>Website</label>
                  <input type="Website" class="form-control" placeholder="Website" name="website" id="website" tabindex="14">
                </div>

                 <div class="form-group">
                  <label>Email</label>
                  <input type="email" class="form-control" placeholder="Email" name="email_id" id="email_id" tabindex="17">
                </div>
                <div class="form-group">
                  <label>GST No</label>
                  <input type="number" class="form-control" placeholder="GST No" name="gst_no" id="gst_no" tabindex="20">
                </div>
            ...
            <!-- form start -->
              <div class="box-body">
                  ...
                  <table>
                    <tr>
                      <div class="field_wrapper">
                        <div>
                          <label>Phone</label>
                          <input type="text" required="phone" maxlength="11" minlength="10" class="form-control" placeholder="03333906233" style="width: 55%" name="phone[]" data-role="phone" value=""/ tabindex="6">
                          <a href="javascript:void(0);" class="add_button " title="Add field" style="position: relative;bottom: 31px;left: 180px;"><img src="<?php echo base_url('assets/images/add-icon.png'); ?>"/></a>
                        </div>
                      </div>
                    </tr>
                ...
                <div class="form-group"  style="margin-top: -10%;">
                    ...
                    <input list="browsers" placeholder="Select Credit Due Date" name="credit_term_desc" id="credit_term_desc" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="9">
                ...
                <div class="form-group">
                    <label>City</label>
                    <select name="city" id="city" required="city" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="12">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Account title" id="exampleInputEmail1" tabindex="15">
                </div>

                <div class="form-group">
                  <label>VAT No</label>
                  <input type="number" class="form-control" placeholder="VAT No" name="vat_no" id="vat_no" tabindex="18">
                </div>

                <div class="form-group">
                  <label>NTN No</label>
                  <input type="number" class="form-control" placeholder="NTN No" name="ntn_no" id="ntn_no" tabindex="21">
                </div>
                ...
                <div class="form-group">
                  ...
                  <p style="position: relative;top: 10px;">
                    <label for="vat_flag">
                    <input type="checkbox" name="vat_flag" value="1" class="checkbox1" tabindex="24">
                    NO VAT
                    </label>
                      <label for="inactive_flag" class="" style="font-weight: 400;margin-left: 2%;">
                        <input type="checkbox" name="inactive_flag" value="1" class="checkbox1" tabindex="25">
                        Suspended
                      </label>
                      <label for="black_list_flag" style="    font-weight: 400;margin-left: 4%;">
                        <input type="checkbox" name="black_list_flag" value="1" class="checkbox1" tabindex="26">
                        Black List
                      </label>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label>Travel No</label>
                  <input type="number" class="form-control" placeholder="Travel No" name="travel_no" id="travel_no" style="    width: 95%;margin-left: 2%;" tabindex="27">
                </div>
        </div>
        <div class="col-md-4">
           <div class="form-group">
              <label>Travel Type</label>
              <select name="travel" id="travel" required="travel" style="width: 100%;border: 1px solid #d4d4d4;padding: 5px;" tabindex="28">
...
$(document).ready(function(){
 $('#country').change(function(){
  ...
  {
   $.ajax({
    url:"<?php echo base_url(); ?>supplier/fetch_state",
    method:"POST",
 ...
 $('#state').change(function(){
  ...
  {
   $.ajax({
    url:"<?php echo base_url(); ?>supplier/fetch_city",
    method:"POST",
