          ...
          <!-- general form elements -->
            ...
            <form role="form" name="myForm" id="myForm" onsubmit="return validateForm()" action="<?php echo base_url('credit'); ?>" method = "post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <?php echo form_label('Credit'); ?><?php echo form_error('credit_term_desc'); ?> <br />
                  <?php echo form_input(array('id' => 'credit_term_desc', 'name' => 'credit_term_desc', 'class'=>'form-control', 'placeholder'=>'e.g 10 days')); ?><br />
                </div>
