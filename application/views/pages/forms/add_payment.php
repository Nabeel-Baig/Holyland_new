          ...
          <!-- general form elements -->
            ...
            <form role="form" name="myForm" id="myForm" onsubmit="validateForm()" action="<?php echo base_url('payment'); ?>" method = "post">
              <div class="box-body">
                ...
                <br>
                <div class="form-group">
                  <?php echo form_label('Payment Method'); ?><?php echo form_error('pay_term_desc'); ?> <br />
                  <input type="text" class="form-control" placeholder="Cash or Credit" name="pay_term_desc" id="pay_term_desc">
                </div>

                <div class="form-group">

                  <label for="inactive_flag" class="" style="    font-weight: 400; margin-top: 3%">
                    <?php echo form_error('inactive_flag'); ?> <br />
