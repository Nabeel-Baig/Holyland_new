      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <!-- general form elements -->
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="myForm" id="myForm" onsubmit="return validateForm()" <?php echo base_url('view'); ?> method="post">
              <div class="box-body">
                <div class="form-group">
                  <label>ID</label>
                  <input type="number" class="form-control" placeholder="ID Auto Generate" disabled>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Short Name" name="hot_view_sht_name" id="hot_view_sht_name">
                </div>
                <!-- <div class="form-group">
                  <input type="number" class="form-control" placeholder="No Of Bed" id="exampleInputEmail1">
                </div> -->
        ...
        <div class="col-md-5">
          ...
          <div class="form-group" style="margin-top: 10px;"> 
            <label>View Name</label> <?php echo form_error('hot_view_desc'); ?>
                  <input type="name" class="form-control" placeholder="Name" name="hot_view_desc" id="hot_view_desc" style="width: 96%;margin-left: 2%;">
                </div>
          ...
          <!-- <form>
            <div class="form-group" style="margin-top: -3%">
              ...
              <textarea class="form-control" rows="5" id="comment" placeholder="Note"></textarea>
            </div>
          </form> -->
...
<div class="col-md-4"></div>
 ...
 <script type="text/javascript">
   function validateForm() {
    var x = document.forms["myForm"]["hot_view_desc"].value;
    if (x == "") {
        alert("View Name must be filled out");
        return false;
    }
    else {
