        ...
        <div class="col-md-5">
          ...
          <form role="form" action="<?php echo base_url('term/add_term_det'); ?>" method="post">
              <div class="box-body">
                ...
                <!--<div class="form-group">-->
                  <!--<input type="email" class="form-control" placeholder="ID" id="exampleInputPassword1">-->
                <!--</div>-->

                <!--<div class="form-group">-->
                  <!--<input type="number" class="form-control" placeholder="T & C ID" id="exampleInputEmail1">-->
                <!--</div>-->
        ...
        <div class="col-md-5">
          <!-- general form elements -->
            ...
            <div class="form-group" style="margin-top: 3%">
              <label>Term Detail</label> <?php echo form_error('term_cond_det_desc'); ?>
                <input type="text" id="term_cond_det_desc" name="term_cond_det_desc" class="form-control" placeholder="Detail" style="width: 96%;margin-left: 2%">
            </div>
            <!--<div class="form-group">-->

              <!--<input type="email" class="form-control" placeholder="Name" id="exampleInputPassword1">-->
           ...
           <div class="row">
             ...
             <div class="col-md-5">
               <div class="form-group">
                 ...
                 <label for="inactive_flag" class="" style="font-weight: 400; margin-left: 9%;">
