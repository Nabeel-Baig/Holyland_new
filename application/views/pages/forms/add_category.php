      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <!-- general form elements -->
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="myForm" id="myForm" action="<?php echo base_url('category'); ?>" onsubmit="return validateForm()" method="post">
              <div class="box-body">
        ...
        <div class="col-md-5">
          ...
          <div class="form-group">
            <?php echo Form_label('Category'); ?> <?php echo Form_error('category_desc'); ?>
            <input id="category_desc" name="category_desc" type="text" class="form-control" placeholder="e.g: Hajj, Umra" style="margin-top: 2%">
          </div>
...
<div class="col-md-4"></div>
    ...
    var x = document.forms["myForm"]["category_desc"].value;
    if (x == "") {
