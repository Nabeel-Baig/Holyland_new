...
MySQL - 10.1.25-MariaDB : Database - travel_portal_db
*********************************************************************
*/
...
/*Data for the table `00000_mst_bed_types` */
...
/*Data for the table `00000_mst_branch` */

insert  into `00000_mst_branch`(`branch_id`,`branch_name`,`inactive_flag`) values (8,'head Office asda',1);

/*Table structure for table `00000_mst_cancel_reasons` */

DROP TABLE IF EXISTS `00000_mst_cancel_reasons`;

CREATE TABLE `00000_mst_cancel_reasons` (
  `can_reasons_id` int(11) NOT NULL AUTO_INCREMENT,
  `reason_name` varchar(100) NOT NULL,
  `note` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`can_reasons_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `00000_mst_cancel_reasons` */

insert  into `00000_mst_cancel_reasons`(`can_reasons_id`,`reason_name`,`note`) values (1,'Test Cancel','Cancel test');
...
/*Data for the table `00000_mst_category` */

insert  into `00000_mst_category`(`category_id`,`category_desc`,`inactive_flag`) values (1,'Hajjs',0),(2,'Umraa',0);
...
/*Data for the table `00000_mst_city` */

insert  into `00000_mst_city`(`city_id`,`city_name`,`city_sht_name`,`state_id`,`country_id`,`inactive_flag`) values (1,'Karachiad','KA',1,1,0);
...
CREATE TABLE `00000_mst_client` (
  ...
  KEY `00000_mst_client_ibfk_9` (`branch_id`),
  ...
  CONSTRAINT `00000_mst_client_ibfk_9` FOREIGN KEY (`branch_id`) REFERENCES `00000_mst_branch` (`branch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `00000_mst_client` */

/*Table structure for table `00000_mst_client_attachments` */

DROP TABLE IF EXISTS `00000_mst_client_attachments`;

CREATE TABLE `00000_mst_client_attachments` (
...
/*Data for the table `00000_mst_client_attachments` */
...
/*Data for the table `00000_mst_client_cont_person` */
...
/*Data for the table `00000_mst_client_contacts` */
...
/*Data for the table `00000_mst_country` */

insert  into `00000_mst_country`(`country_id`,`country_name`,`country_sht_name`,`inactive_flag`) values (1,'TESTED','TEST',0);
...
/*Data for the table `00000_mst_credit_terms` */

insert  into `00000_mst_credit_terms`(`credit_term_id`,`no_of_days`,`credit_term_desc`,`note`,`inactive_flag`) values (1,212,'10 Dyas','adas',0);

/*Table structure for table `00000_mst_hotel_attachments` */

DROP TABLE IF EXISTS `00000_mst_hotel_attachments`;

CREATE TABLE `00000_mst_hotel_attachments` (
...
/*Data for the table `00000_mst_hotel_attachments` */
...
/*Data for the table `00000_mst_hotels` */
...
/*Data for the table `00000_mst_hotels_cont_person` */
...
/*Data for the table `00000_mst_hotels_contacts` */
...
/*Data for the table `00000_mst_hotels_meal_plans` */
...
/*Data for the table `00000_mst_hotels_rooms` */
...
CREATE TABLE `00000_mst_hotels_views` (
  ...
  CONSTRAINT `00000_mst_hotels_views_ibfk_2` FOREIGN KEY (`hot_view_id`) REFERENCES `00000_mst_views` (`hot_view_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `00000_mst_hotels_views` */
...
/*Data for the table `00000_mst_meal_plans` */
...
/*Data for the table `00000_mst_payment_terms` */

insert  into `00000_mst_payment_terms`(`pay_terms_id`,`pay_term_desc`,`note`,`inactive_flag`) values (1,'Cash TEst','TEST',0);
...
/*Data for the table `00000_mst_room_types` */

insert  into `00000_mst_room_types`(`room_id`,`room_type_name`,`arabic_name`,`no_of_persons`,`note`,`inactive_flag`) values (1,'Testing Room',NULL,54,'Test',0);
...
/*Data for the table `00000_mst_salesperson` */

insert  into `00000_mst_salesperson`(`salesperson_id`,`salesperson_name`,`employee_id`,`commmission_per`,`commission_fix`,`inactive_flag`) values (1,'asd',NULL,9.99,15.00,0);
...
/*Data for the table `00000_mst_seasons` */

insert  into `00000_mst_seasons`(`season_id`,`seeson_name`,`gor_from_date`,`gor_to_date`,`hij_from_date`,`hij_to_date`,`term_cond_id`,`term_cond_det_id`,`inactive_flag`) values (1,'Nabeel Baig','2018-10-10','2018-10-18','1440-02-05','1440-02-06',1,1,0);
...
/*Data for the table `00000_mst_state` */

insert  into `00000_mst_state`(`state_id`,`state_name`,`state_sht_name`,`country_id`,`inactive_flag`) values (1,'Sindh','ST TEST',1,1);
...
/*Data for the table `00000_mst_supplier` */

/*Table structure for table `00000_mst_supplier_attachments` */

DROP TABLE IF EXISTS `00000_mst_supplier_attachments`;

CREATE TABLE `00000_mst_supplier_attachments` (
...
/*Data for the table `00000_mst_supplier_attachments` */
...
/*Data for the table `00000_mst_supplier_cont_person` */
...
/*Data for the table `00000_mst_supplier_contacts` */
...
/*Data for the table `00000_mst_terms_condition` */

insert  into `00000_mst_terms_condition`(`term_cond_id`,`term_cond_desc`,`arabic_desc`,`inactive_flag`) values (1,'Laptop',NULL,0);
...
/*Data for the table `00000_mst_terms_condition_detail` */

insert  into `00000_mst_terms_condition_detail`(`term_cond_det_id`,`term_cond_id`,`term_cond_det_desc`,`inactive_flag`) values (1,1,'Rams',0);
...
/*Data for the table `00000_mst_travel_type` */

insert  into `00000_mst_travel_type`(`travel_type_id`,`travel_type_desc`,`travel_type_sht_desc`,`inactive_flag`) values (1,'Hajj and Umra','testsad',1);
...
CREATE TABLE `00000_mst_views` (
  `hot_view_id` int(11) NOT NULL AUTO_INCREMENT,
  `hot_view_desc` varchar(50) NOT NULL,
  `hot_view_sht_name` varchar(10) NOT NULL,
  `inactive_flag` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`hot_view_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `00000_mst_views` */
...
/*Data for the table `00000_sys_users` */
